using CoreBridgeCRM.Application.UseCases.Expenses.Reports.Pdf.Colors;
using CoreBridgeCRM.Application.UseCases.Expenses.Reports.Pdf.Fonts;
using CoreBridgeCRM.Domain.Extensions;
...
namespace CoreBridgeCRM.Application.UseCases.Expenses.Reports.Pdf;
