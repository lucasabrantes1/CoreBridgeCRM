...
public class CoreBridgeCRMClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public CoreBridgeCRMClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
