...
public class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseEnvironment("Test")
            .ConfigureServices(services =>
            {
                ...
                services.AddDbContext<CoreBridgeCRMDbContext>(config =>
                {
                ...
                var dbContext = scope.ServiceProvider.GetRequiredService<CoreBridgeCRMDbContext>();
    ...
    private void StartDatabase(
        CoreBridgeCRMDbContext dbContext,
    ...
    private Expense AddExpenses(CoreBridgeCRMDbContext dbContext, User user, long expenseId, long tagId)
    {
